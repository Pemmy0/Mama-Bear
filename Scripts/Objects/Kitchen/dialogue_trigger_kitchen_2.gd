...
var test = ObjectLibrary.kitchen_trigger2
...
func _on_body_entered(body):
	...
	player_in_area = true
	if (
		body.is_in_group("player") && !ObjectLibrary.has_interacted_kitchen2 &&
		ObjectLibrary.has_interacted_kitchen1
	):
		...
		ObjectLibrary.has_interacted_kitchen2 = true
